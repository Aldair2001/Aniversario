...
const CONTRASENA = "150104"; // Cambia esto por la contraseña que desees
...
function actualizarContador() {
    const fechaInicio = new Date('2024-12-18T00:00:00'); // Cambia esta fecha según necesites
    ...
    document.getElementById('anos').textContent = `${anos} AÑOS`;
